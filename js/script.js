...
// Legacy script neutralized.
// The original implementation was moved to `js/legacy-script.js` to avoid conflicts with the new React app.
// If you need to restore or run the legacy viewer, open `js/legacy-script.js`.

// NOTE: This file intentionally left minimal to prevent double-loading two viewers.
    } catch (e) {
